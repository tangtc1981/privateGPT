...
## [0.0.1](https://github.com/tangtc1981/privateGPT/compare/v0.2.0...v0.0.1) (2024-02-08)


### Features

* add mistral + chatml prompts ([#1426](https://github.com/tangtc1981/privateGPT/issues/1426)) ([e326126](https://github.com/tangtc1981/privateGPT/commit/e326126d0d4cd7e46a79f080c442c86f6dd4d24b))
* Add stream information to generate SDKs ([#1569](https://github.com/tangtc1981/privateGPT/issues/1569)) ([24fae66](https://github.com/tangtc1981/privateGPT/commit/24fae660e6913aac6b52745fb2c2fe128ba2eb79))
* **API:** Ingest plain text ([#1417](https://github.com/tangtc1981/privateGPT/issues/1417)) ([6eeb95e](https://github.com/tangtc1981/privateGPT/commit/6eeb95ec7f17a618aaa47f5034ee5bccae02b667))
* **bulk-ingest:** Add --ignored Flag to Exclude Specific Files and Directories During Ingestion ([#1432](https://github.com/tangtc1981/privateGPT/issues/1432)) ([b178b51](https://github.com/tangtc1981/privateGPT/commit/b178b514519550e355baf0f4f3f6beb73dca7df2))
...
* **llm:** Add openailike llm mode ([#1447](https://github.com/tangtc1981/privateGPT/issues/1447)) ([2d27a9f](https://github.com/tangtc1981/privateGPT/commit/2d27a9f956d672cb1fe715cf0acdd35c37f378a5)), closes [#1424](https://github.com/tangtc1981/privateGPT/issues/1424)
* **llm:** drop default_system_prompt ([#1385](https://github.com/tangtc1981/privateGPT/issues/1385)) ([a3ed14c](https://github.com/tangtc1981/privateGPT/commit/a3ed14c58f77351dbd5f8f2d7868d1642a44f017))
...
* **settings:** Configurable context_window and tokenizer ([#1437](https://github.com/tangtc1981/privateGPT/issues/1437)) ([4780540](https://github.com/tangtc1981/privateGPT/commit/47805408703c23f0fd5cab52338142c1886b450b))
* **settings:** Update default model to TheBloke/Mistral-7B-Instruct-v0.2-GGUF ([#1415](https://github.com/tangtc1981/privateGPT/issues/1415)) ([8ec7cf4](https://github.com/tangtc1981/privateGPT/commit/8ec7cf49f40701a4f2156c48eb2fad9fe6220629))
...
* **ui:** Allows User to Set System Prompt via "Additional Options" in Chat Interface ([#1353](https://github.com/tangtc1981/privateGPT/issues/1353)) ([145f3ec](https://github.com/tangtc1981/privateGPT/commit/145f3ec9f41c4def5abf4065a06fb0786e2d992a))
* **ui:** make chat area stretch to fill the screen ([#1397](https://github.com/tangtc1981/privateGPT/issues/1397)) ([c71ae7c](https://github.com/tangtc1981/privateGPT/commit/c71ae7cee92463bbc5ea9c434eab9f99166e1363))
...
* Adding an LLM param to fix broken generator from llamacpp ([#1519](https://github.com/tangtc1981/privateGPT/issues/1519)) ([869233f](https://github.com/tangtc1981/privateGPT/commit/869233f0e4f03dc23e5fae43cf7cb55350afdee9))
...
* **deploy:** fix local and external dockerfiles ([fde2b94](https://github.com/tangtc1981/privateGPT/commit/fde2b942bc03688701ed563be6d7d597c75e4e4e))
...
* **docker:** docker broken copy ([#1419](https://github.com/tangtc1981/privateGPT/issues/1419)) ([059f358](https://github.com/tangtc1981/privateGPT/commit/059f35840adbc3fb93d847d6decf6da32d08670c))
* **docs:** Update quickstart doc and set version in pyproject.toml to 0.2.0 ([0a89d76](https://github.com/tangtc1981/privateGPT/commit/0a89d76cc5ed4371ffe8068858f23dfbb5e8cc37))
...
* minor bug in chat stream output - python error being serialized ([#1449](https://github.com/tangtc1981/privateGPT/issues/1449)) ([6191bcd](https://github.com/tangtc1981/privateGPT/commit/6191bcdbd6e92b6f4d5995967dc196c9348c5954))
...
* **settings:** correct yaml multiline string ([#1403](https://github.com/tangtc1981/privateGPT/issues/1403)) ([2564f8d](https://github.com/tangtc1981/privateGPT/commit/2564f8d2bb8c4332a6a0ab6d722a2ac15006b85f))
* **tests:** load the test settings only when running tests ([d3acd85](https://github.com/tangtc1981/privateGPT/commit/d3acd85fe34030f8cfd7daf50b30c534087bdf2b))
...
* Windows 11 failing to auto-delete tmp file ([#1260](https://github.com/tangtc1981/privateGPT/issues/1260)) ([0d52002](https://github.com/tangtc1981/privateGPT/commit/0d520026a3d5b08a9b8487be992d3095b21e710c))
* Windows permission error on ingest service tmp files ([#1280](https://github.com/tangtc1981/privateGPT/issues/1280)) ([f1cbff0](https://github.com/tangtc1981/privateGPT/commit/f1cbff0fb7059432d9e71473cbdd039032dab60d))
